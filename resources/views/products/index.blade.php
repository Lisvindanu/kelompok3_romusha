...
<div class="container mx-auto my-6 px-4">
    ...
    <form id="product-form" class="bg-white p-4 shadow-md rounded-lg mb-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="product-name" class="border rounded w-full py-2 px-3" placeholder="Enter product name" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="product-price" class="border rounded w-full py-2 px-3" placeholder="Enter product price" required>
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 font-medium mb-2">Quantity</label>
            <input type="number" id="product-quantity" class="border rounded w-full py-2 px-3" placeholder="Enter product quantity" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="file" id="product-image" class="border rounded w-full py-2 px-3" accept="image/*" onchange="previewImage(event)">
            <img id="image-preview" class="mt-4 w-full h-auto rounded shadow-md" style="display: none;" alt="Image Preview">
        </div>

        <button type="button" onclick="saveProduct()" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
            Save Product
        </button>
    </form>
...
<script>
    ...
    async function saveProduct() {
        ...
        const productData = {
            ...
            genreIds: Array.from(document.querySelectorAll('input[name="genres"]:checked')).map(input => parseInt(input.value)),
        };
