<x-layout>
    ...
    <div class="flex min-h-screen flex-col items-center px-4 md:px-10 mt-10 zoom-responsive">
        <!-- Title -->
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 mt-7 text-center text-white font-pixelify">E-Wallet
        </h1>
        <!-- Cards Wrapper -->
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1 class="text-sm sm:text-base md:text-lg font-bold text-white">Steam Wallet</h1>
                            ...
                            <p
                                ...
                                Steam Wallet memudahkan pembelian game dan konten di Steam dengan saldo yang dapat diisi ulang
                            </p>
                            <a href="/detail-ewallet"
