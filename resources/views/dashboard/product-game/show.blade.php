                ...
                <div class="bg-white rounded-lg shadow-lg max-w-4xl w-full p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="flex flex-col">
                            <h1 class="text-3xl font-bold text-gray-800 mb-4">Super Mario</h1>
                            <p class="text-sm text-gray-600 italic mb-6">
                                Super Mario adalah game ikonik yang telah menjadi favorit para gamer sejak lama. Dengan
                                gameplay
                                yang
                                seru dan grafis yang menarik, game ini cocok untuk semua kalangan. Miliki koleksi ini
                                untuk
                                melengkapi
