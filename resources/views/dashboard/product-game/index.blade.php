<x-layout-dashboard>
    <div class="flex flex-col min-h-screen md:flex-row">
        ...
        <main class="flex-1 p-6">
            ...
            {{-- Game --}}
            <div class="flex justify-between items-center border-b pb-4 mb-4">
                <h1 class="text-2xl font-semibold">Product Game</h1>
            </div>
                    ...
                    <div class="flex flex-col space-y-4">
                        <div class="border border-gray-200 rounded p-4 hover:bg-gray-50">
                            <div class="flex justify-between">
                                ...
                                <span class="text-gray-500 text-sm">10 stok</span>
                            </div>
                            <div class="flex items-center space-x-2 mt-2">
                                <!-- View -->
                                <a href="/dashboard/show-product-game" class="text-blue-500 hover:text-blue-700">
                                    <span
                                ...
                                <!-- Edit -->
                                <a href="/dashboard/edit-product-game" class="text-yellow-500 hover:text-yellow-700">
                                    <span
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
                                    <div class="flex items-center space-x-2">
                                        <a href="/dashboard/show-product-game"
                                        ...
                                        <a href="/dashboard/edit-product-game"
            ...
            {{-- E-Voucher --}}
            <div class="flex justify-between items-center border-b pb-4 mb-4">
                <h1 class="text-2xl font-semibold">Product E-Voucher</h1>
            </div>
