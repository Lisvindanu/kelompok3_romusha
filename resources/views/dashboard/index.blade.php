        ...
        <main class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-800 rounded-lg p-6 flex flex-col items-center justify-between shadow-lg">
                    <i class="fas fa-gamepad fa-5x text-gray-400 mb-4"></i>
                    <h3 class="text-gray-200 text-xl font-bold">Produk Game</h3>
                    <p class="text-gray-400 text-lg">10 Produk</p>
                    <a href="/dashboard/product-game" class="text-blue-500 hover:text-blue-400 no-underline">Lihat Detail</a>
                </div>

                <!-- Box Produk Console -->
                <div class="bg-gray-800 rounded-lg p-6 flex flex-col items-center justify-between shadow-lg">
                    <i class="fas fa-tv fa-5x text-gray-400 mb-4"></i>
                    <h3 class="text-gray-200 text-xl font-bold">Produk Console</h3>
                    <p class="text-gray-400 text-lg">10 Produk</p>
                    <a href="/dashboard/product-console" class="text-blue-500 hover:text-blue-400 no-underline">Lihat Detail</a>
                </div>
