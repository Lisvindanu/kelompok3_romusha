<footer class="bg-yellow-400 text-red-700 py-8">
    <div class="container mx-auto px-4 text-center">
        <!-- Logo or Title -->
        <h2 class="text-2xl font-bold mb-4 font-pixelify">Retro Game Hub</h2>
        ...
        <div class="flex justify-center space-x-4 mb-4">
            <a href="#" class="hover:opacity-75" aria-label="Facebook">
        ...
        <!-- Copyright -->
        <p class="text-sm font-pixelify">© 2024 RetroGameHub | All rights reserved.</p>
    </div>
</footer>