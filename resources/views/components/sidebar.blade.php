        ...
        <div class="p-4 mt-16"> <!-- Adjusted for desktop and mobile -->
            <nav class="space-y-2">
                ...
                <a href="/dashboard/product-game"
                    ...
                    <i class="fas fa-gamepad"></i> Produk Game
                </a>

                <!-- Produk Console -->
                <a href="/dashboard/product-console"
                    class="block py-2 px-3 rounded {{ request()->is('dashboard/product-console*') ? 'bg-gray-200 text-gray-900' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }} text-sm font-medium"
                    aria-current="{{ request()->is('dashboard/product-console*') ? 'page' : false }}">
                    <i class="fas fa-tv"></i> Produk Console
                </a>
                ...
                <a href="/dashboard/genre-game"
                    ...
                    <i class="fas fa-layer-group"></i> Produk Genre
                </a>
            </nav>
