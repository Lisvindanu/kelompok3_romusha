<x-layout>
    ...
    <div class="flex min-h-screen flex-col items-center px-4 md:px-10 mt-10 zoom-responsive">
        <!-- Title -->
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 mt-7 text-center text-white font-pixelify">Game
        </h1>
        <!-- Cards Wrapper -->
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1 class="text-sm sm:text-base md:text-lg font-bold text-white">Mario Bros</h1>
