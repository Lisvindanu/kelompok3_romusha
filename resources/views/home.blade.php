<x-layout>
    ...
    {{-- JUDUL  --}}
    <div class="flex min-h-screen flex-col items-center px-4 md:px-10  pt-40"
        style="background: linear-gradient(180deg, #d7550a 1%, rgba(255, 255, 255, 0) 20%);">
        <!-- Title -->
        <h1 class="text-4xl font-bold mb-8 mt-10 text-center text-white ">Featured Games</h1>
        <!-- Cards Wrapper -->
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Card 1 -->
                <div
                    class="group relative items-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-lg bg-white">
                    ...
                    <div
                        ...
                        <div
                            class="absolute inset-0 flex flex-col items-center justify-center px-6 text-center translate-y-[60%] group-hover:translate-y-0 transition-all">
